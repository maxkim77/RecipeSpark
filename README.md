# RecipeSpark 서비스 기획서 (Java Spring Boot 기반 모놀리식 구조 - 권한 관리 포함)

## 1. 서비스 개요
**RecipeSpark**는 요리 애호가들이 다양한 레시피를 공유하고, 질문과 답변을 통해 요리에 관한 궁금증을 해결하며, AI를 활용한 맞춤 레시피 추천과 변환 기능을 제공하는 웹 서비스입니다.
